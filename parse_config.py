...
class ConfigParser:
    def __init__(self, config, resume=None, modification=None, load_crt=None, run_id=None, test=False):
        """
    ...
    def from_args(cls, args, options='', test=False):
        ...
        return cls(config, resume, modification, load_crt=load_crt, test=test)
